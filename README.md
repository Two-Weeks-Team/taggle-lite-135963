...
> Simple, local‑only bookmark manager – add, search and export links without any login or cloud.

---

## Overview

People want a quick way to save personal web links without installing extensions, creating accounts, or sending any data to a server.
...
services:
  - name: api
    github:
      repo: Two-Weeks-Team/taggle-lite
      branch: master
